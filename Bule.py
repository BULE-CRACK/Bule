...
pretty.install()
CON=sol()
ugen2='Mozilla/5.0 (Linux; U; Android 4.1.2; en-ca; GT-S6310N Build/JZO54K) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30'
ugen='Mozilla/5.0 (BB10; Kbd) AppleWebKit/537.35+ (KHTML, like Gecko) Version/10.3.3.2205 Mobile Safari/537.35+''
cokbrut=[]
...
for xd in range(10000):
	...
	uaku='Mozilla/5.0 (Linux; U; Android 4.4.2; en-us; SCH-I535 Build/KOT49H) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30'
	ugen2='Mozilla/5.0 (BB10; Kbd) AppleWebKit/537.35+ (KHTML, like Gecko) Version/10.3.3.2205 Mobile Safari/537.35+''
...
def menu(my_name,my_id):
	...
	_____pariz__bule_____ = input('\n>> Pilih : ')
	if _____pariz__bule_____ in ['1']:
		dump_massal()	
	elif _____pariz__bule_____ in ['2']:
		result()
	elif _____pariz__bule_____ in ['0']:
